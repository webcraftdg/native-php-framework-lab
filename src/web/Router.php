...
use webcraftdg\framework\exceptions\HttpException;
use ReflectionClass;
use ReflectionMethod;
use webcraftdg\framework\exceptions\RouterException;
...
class Router
{
    ...
    public function dispatch(): mixed
    {
        ...
        $controllerInstance = $reflection->newInstance(App::$app, $controllerId);
